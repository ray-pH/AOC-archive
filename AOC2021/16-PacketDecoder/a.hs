...
getVersionSum packet = version + (sum containedVersions)
    where Pack version _ _ _ containedPackets = packet
          containedVersions = map getVersionSum containedPackets
...
main = do
    ...
    let lin = lines cont
        ...
        result = getVersionSum parsed
    -- print inp
    -- print $ parseLiteral "101111111000101000"
    -- print parsed
    -- print trash
    print result
